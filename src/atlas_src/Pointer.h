...
static const unsigned int GB4xxx = 6;
static const unsigned int GIZMO = 7;
static const unsigned int MSB16 = 8;
static const unsigned int MSB24 = 9;
static const unsigned int MSB32 = 10;

static const unsigned int AddressTypeCount = 8+3;
static const char* AddressTypes[AddressTypeCount] = { "INVALID", "LINEAR", "LOROM00", "LOROM80",
	"HIROM", "GB", "GB4xxx", "GIZMO", "MSB16", "MSB24", "MSB32" };
...
private:
	...
	unsigned int GetGB4xxxAddress(unsigned int Offset) const;
	unsigned int GetMSBAddress(unsigned int Offset, int size) const;
};
...
public:
	...
	unsigned int GetPointerOffset() const;
...
public:
	...
	unsigned int GetPointerValueOffset(const unsigned int PointerNum);
